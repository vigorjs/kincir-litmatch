...
public class ProductStockRepositoryImpl implements ProductStockRepository {
    ...
    public ProductStock save(ProductStock stock) {
        String sql = "INSERT INTO stocks (products_id, quantity) VALUES (?, ?) RETURNING id, products_id, quantity";
    ...
    public Optional<ProductStock> findByProductId(Integer productId) {
        String sql = "SELECT * FROM stocks WHERE products_id = ?";
        try {
    ...
    public void update(ProductStock stock) {
        String sql = "UPDATE stocks SET products_id = ?, quantity = ? WHERE id = ?";
